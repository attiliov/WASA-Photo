...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.GET("/users", rt.searchUser) // TESTED on frontend
	...
	rt.router.GET("/users/:userId/followers", rt.getFollowersList) // TESTED on frontend

	rt.router.GET("/users/:userId/following", rt.getFollowingsList) // TESTED on frontend
	...
	rt.router.GET("/users/:userId/feed", rt.getFeed) // TESTED on frontend
